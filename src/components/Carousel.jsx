            ...
            >
              <div className="flex flex-col md:flex-row gap-10 justify-center h-[600px] my-20 md:my-0 items-center px-4">
                <div className="md:space-y-6 space-y-3">
                  ...
                  <h1 className="text-xl md:text-4xl uppercase font-bold  line-clamp-2  md:line-clamp-3 md:w-[500px] text-white">
                    {item.title}
                  </h1>
                ...
                <div>
                  <img
                    src={item.image}
                    alt={item.title}
                    className="rounded-full h-[385px] w-[300px] md:w-[550px] md:h-[600px] hover:scale-105 transition-all shadow-xl shadow-red-400"
                  />
                </div>
              </div>
            </div>
